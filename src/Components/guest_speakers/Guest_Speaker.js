            ...
            <section class="special-guest spad">
                <div class="container">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="guest-info">
                                ...
                                <div class="guest-links">
                                    ...
                                    <a href="https://twitter.com/inctf" class="twitter"><i class="fab fa-twitter"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row newone">
                        <div class="col-xl-4 col-lg-5">
                            <div class="guest-img">
                                <img src={require('../../images/rahul.jpg').default} alt="" data-pagespeed-url-hash="2156928296" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-7">
                            <div class="guest-info">
