  ...
  return (
    <div className="organizer">
            ...
            <div className="col-md-4 order-md-1 order-2 text-right amrita">
              <a href="https://amrita.edu">
                <img
                  ...
                  src={
                    require("../../images/logos/amritapuri_dark.png").default
                  }
                />
              </a>
            ...
            <div className="col-md-4 cyber order-md-2 order-1">
              <a href="https://www.amrita.edu/center/cyber-security">
                <img
                  className="img1"
                  alt="Team bi0s"
                  src={require("../../images/logos/amrita_cyber.png").default}
                />
              </a>
      ...
      <img
        ...
        draggable="false"
        src={require("../../images/logos/amritapuri_vector.png").default}
      />
    </div>
  );
}
