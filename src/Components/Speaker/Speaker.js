                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="down-content">
                                        <h2 style={{color: 'white'}}>Introduction to Cyber Forensics </h2>
                    ...
                    <div className="col-lg-12">
                        <div className="trainer-item">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="down-content">
                                        <h2 style={{color: 'white'}}>Intro to Gameboy and NES ROM Reversing </h2>
                                        <h5 style={{color: 'chocolate'}}>Gourav Singh Bajeli</h5>
                                    </div>
                                    <div className="image-thumb">
                                        <img src={require('../../images/rahul.jpg').default} alt="" />
                                    </div>
                    ...
                    <div className="col-lg-12">
                        <div className="trainer-item">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="down-content">
                                        <h2 style={{color: 'white'}}>Vulnerabilities In Real World Crypto </h2>
                    ...
                    <div className="col-lg-12">
                        <div className="trainer-item">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="down-content">
                                        <h2 style={{color: 'white'}}>Crypto for Beginners </h2>
                    ...
                    <div className="col-lg-12">
                        <div className="trainer-item">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="down-content">
                                        <h2 style={{color: 'white'}}>Intro to Binary Exploitation </h2>
                        ...
                        <div className="trainer-item">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="down-content">
                                        <h2 style={{color: 'white'}}>Intro to Binary Exploitation </h2>
                                        <h5 style={{color: 'chocolate'}}>Adhithya Sree Mohan</h5>
                                    </div>
                                    <div className="image-thumb">
                                        <img src={require('../../images/rahul.jpg').default} alt="" />
                                    </div>
                    ...
                    <div className="col-lg-12">
                        <div className="trainer-item">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="down-content">
                                        <h2 style={{color: 'white'}}>Introduction to the Web </h2>
                    ...
                    <div className="col-lg-12">
                        <div className="trainer-item">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="down-content">
                                        <h2 style={{color: 'white'}}>Exploring Web Exploitation Techniques </h2>
                                        <h5 style={{color: 'chocolate'}}>Sayooj B Kumar</h5>
                                    </div>
                                    <div className="image-thumb">
                                        <img src={require('../../images/rahul.jpg').default} alt="" />
                                    </div>
                    ...
                    <div className="col-lg-12">
                        <div className="trainer-item">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="down-content">
                                        <h2 style={{color: 'white'}}>Introduction to Reverse Engineering </h2>
