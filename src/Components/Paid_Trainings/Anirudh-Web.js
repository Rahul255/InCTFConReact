                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 about-text"><br /><br />
                            <div class=" m-auto about-head ">
                                ...
                                <p className="paragr">This course is a 100% hands-on deep dive into the OWASP Security Testing Guide and
                                    relevant items of the OWASP Application Security Verification Standard (ASVS), so this
                                    course covers and goes beyond the OWASP Top Ten.</p>
                                <p className="paragr">Long are the days since web servers were run by perl scripts apps written in Delphi.
                                    What is common between Walmart, eBay, PayPal, Microsoft, LinkedIn, Google and
                                    Netflix? They all use Node.js: JavaScript on the server.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 about-text"><br /><br />
                            ...
                            <div class=" m-auto about-head ">
                                ...
                                <p className="paragr">This course has no prerequisites as it is designed to accommodate students with
                                    different skills:
                                </p>
                            ...
                            <div class=" m-auto about-head ">
                                ...
                                <ul>
                                    ...
                                    <li class="two" >
                                        ...
                                        assessments</li>
                                    <li class="two" >
                                        Skills can be sharpened via continued education in our training portal for free</li>
                                    <li class="two" >
                                        The student is equipped to defeat common Web app assessment challenges</li>
                                    <li class="two" >
                                        Everybody will learn a lot in this training.</li>
                                    <li class="two" >
